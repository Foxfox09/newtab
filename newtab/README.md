...
- `//play <назва пісні>` — знайти та відтворити музику на YouTube Music.
...
- Детальніше див. у [release notes](https://github.com/Foxfox09/newtab/releases/tag/1.2.022beta).
...
- `//play <song name>` — find and play music on YouTube Music.
...
- See the [release notes](https://github.com/Foxfox09/newtab/releases/tag/1.2.022beta) for more details.